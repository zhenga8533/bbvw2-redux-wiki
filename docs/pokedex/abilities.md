...
Complete list of all abilities in **Blaze Black 2 & Volt White 2 Redux**.
...
| [Healer](abilities/healer.md) | Has a 30% chance of curing each adjacent ally of any major status ailment after each turn. |
...
| [Light Metal](abilities/light-metal.md) | Halves the Pokémon's weight. |
...
| [Teravolt](abilities/teravolt.md) | Bypasses targets' abilities if they could hinder or prevent moves. |
