...
from bbvw2_redux_wiki.utils.core.executor import run_generators, run_parsers
from bbvw2_redux_wiki.utils.core.initializer import PokeDBInitializer
from bbvw2_redux_wiki.utils.core.logger import get_logger
from bbvw2_redux_wiki.utils.core.registry import (
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m bbvw2_redux_wiki --init                        # Initialize PokeDB data
  python -m bbvw2_redux_wiki --parsers all                 # Run all parsers
  python -m bbvw2_redux_wiki --parsers npcs items          # Run specific parsers
  python -m bbvw2_redux_wiki --generators all              # Run all generators
  python -m bbvw2_redux_wiki --generators pokemon          # Run specific generator
  python -m bbvw2_redux_wiki --init --parsers all          # Initialize data and run all parsers
        """,
    )
