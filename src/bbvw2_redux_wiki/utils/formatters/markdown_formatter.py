...
from bbvw2_redux_wiki.utils.core.config import PARSER_DEX_RELATIVE_PATH
...
from bbvw2_redux_wiki.utils.data.models import Ability, Item, Move, Pokemon
from bbvw2_redux_wiki.utils.data.pokemon import get_pokemon_sprite
