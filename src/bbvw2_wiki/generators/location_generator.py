...
from bbvw2_wiki.generators.base_generator import BaseGenerator
from bbvw2_wiki.utils.core.config import GENERATOR_DEX_RELATIVE_PATH
...
from bbvw2_wiki.utils.formatters.yaml_formatter import update_mkdocs_nav
...
class LocationGenerator(BaseGenerator):
    ...
    def generate_index(
        ...
        """
        from bbvw2_wiki.utils.core.config import GAME_TITLE
