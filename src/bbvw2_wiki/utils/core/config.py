...
GENERATORS_REGISTRY: dict[str, dict[str, Any]] = {
    "pokemon": {
        "module": "bbvw2_wiki.generators.pokemon_generator",
        "class": "PokemonGenerator",
        "output_dir": "docs/pokedex",
    },
    "abilities": {
        "module": "bbvw2_wiki.generators.ability_generator",
        "class": "AbilityGenerator",
        "output_dir": "docs/pokedex",
    },
    "items": {
        "module": "bbvw2_wiki.generators.item_generator",
        "class": "ItemGenerator",
        "output_dir": "docs/pokedex",
    },
    "moves": {
        "module": "bbvw2_wiki.generators.move_generator",
        "class": "MoveGenerator",
        "output_dir": "docs/pokedex",
    },
    "locations": {
        "module": "bbvw2_wiki.generators.location_generator",
