...
class PokeDBLoader:
    ...
    def iterate_pokemon(
        ...
        This method consolidates the Pokemon iteration logic previously duplicated
        ...
        Args:
            subfolders: List of subfolder names to scan (e.g., ["default", "transformation", "variant"])
                       If None, uses ["default", "transformation", "variant"]
        ...
        Example:
            ...
            >>> for pokemon in PokeDBLoader.iterate_pokemon(subfolders=["default", "transformation", "variant", "cosmetic"]):
            ...     print(pokemon.name)
        """
        if subfolders is None:
